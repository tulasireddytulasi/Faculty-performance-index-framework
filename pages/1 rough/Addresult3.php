            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user "></i> Details<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                   ...
                                   include 'dbconfig.php';
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) { ?>
                                           <tr>
   <td> <input class="form-control" type="text" name="course" value="<?php echo ''.$row["course"] ?>" disabled ></td>
    <td> <input class="form-control" type="text" name="dept" value="<?php echo ''.$row["dept_name"] ?>" disabled></td>       
    <td> <input class="form-control" type="text" name="year" value="<?php echo ''.$row["year"] ?>" disabled></td>
    <td> <input class="form-control" type="text" name="sem" value="<?php echo ''.$row["sem"] ?>" disabled></td>
    <td> <input class="form-control" type="text" name="sub" value="<?php echo ''.$row["sub_name"] ?>" disabled></td>
