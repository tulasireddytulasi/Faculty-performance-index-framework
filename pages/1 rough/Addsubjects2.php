...
<div id="page-wrapper">
        <div class="container-fluid">
                        ...
                        <h1 align="center" class="page-header">Add Subject Names</h1>
 ...
 <div class="table-responsive">
    ...
    <table class="table table-bordered" id="crud_table">
     <tr>
      ...
      <th width="25%"><center>Subjects Name</center></th>
      <th width="20%"><center>Branch</center></th>
      <th width="10%"><center>Course</center></th>
      <th width="15%"><center>Semester</center></th>
      <th width="5%"></th>
     </tr>
     <tr>
...
$(document).ready(function(){
 ...
 $('#save').click(function(){
  ...
  $.ajax({
   ...
   method:"POST",
   data:{name:name, branch:branch, course:course, sem:sem},
