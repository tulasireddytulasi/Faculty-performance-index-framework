...
<div id="page-wrapper">
        <div class="container-fluid">
                        ...
                        <h1 align="center" class="page-header">Add Articles</h1>
 ...
 <div class="table-responsive">
    ...
    <table class="table table-bordered" id="crud_table">
     <tr>
      ...
      <th width="20%">Article Ttile</th>
      <th width="23%">Publication</th>
...
$(document).ready(function(){
 ...
 $('#save').click(function(){
  ...
  $.ajax({
   url:"insertarticles.php",
   method:"POST",
   data:{title:title, pub:pub, month:month, year:year},
