...
<div id="page-wrapper">
        <div class="container-fluid">
                        ...
                        <h1 align="center" class="page-header">Add Courses Undertaken</h1>
 ...
 <div class="table-responsive">
    ...
    <table class="table table-bordered" id="crud_table">
     ...
     <tr>
      ...
      <td contenteditable="true" class="org"></td>
...
$(document).ready(function(){
 ...
 $('#add').click(function(){
  ...
  var html_code = "<tr id='row"+count+"'>";
   ...
   html_code += "<td contenteditable='true' class='org'></td>";
 ...
 $('#save').click(function(){
  ...
  $.ajax({
   ...
   method:"POST",
   data:{name:name, org:org, fromdate:fromdate, todate:todate},
