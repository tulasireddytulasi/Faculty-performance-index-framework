            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user "></i> Event Details<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
<div id="page-wrapper">
        <div class="container-fluid">
                        ...
                        <h1 align="center" class="page-header">Add Results</h1>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="saveresult.php" method="post">
                                        <div class="form-group">
                                            <label>Year</label>
                                            <input class="form-control" id="year" placeholder="Enter Year" name="year">
                                            <label id="stafferr1"></label>
                                        </div>
                                        <div class="form-group">
                                            <label>Semester</label>
                                            <input class="form-control" id="sem" placeholder="Enter Semester" name="sem">
                                            <label id="stafferr2"></label>
                                        </div> 
                                        <div class="form-group">
                                            <label>Subject Name</label>
                                            <input class="form-control" id="sub" placeholder="Enter Subject Name" name="sub">
                                            <label id="stafferr2"></label>
                                        </div>  
                                        <div class="form-group">
                                            <label>Pass Percentage (%)</label>
                                            <input class="form-control" id="pass" placeholder="Enter Pass Percentage (%)" name="pass">
                                            <label id="stafferr2"></label>
                                        </div> 
