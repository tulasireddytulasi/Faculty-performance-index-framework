            ...
            <div class="container-fluid">
                     ...
                     <center> 
                      <select class="form-control" name="fid" >
                                   ...
                                   include 'dbconfig.php';
                                    ...
                                    $sql = "SELECT * FROM userinfo where course = '$course' and branch = '$branch' and role = 'Faculty'";
                   ...
                   <table width="100%" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td class="info">Analytical Ability</td>
                    </tr>
                    <tr><td></td><td>
                     ...
                     <tr>
                      ...
                      <td class="danger">Decision Making</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                ...
                <td class="info">Initiative Nature</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                     ...
                     <tr>
                      ...
                      <td class="danger">Completion of Assigned Works</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                     ...
                     <tr>
                      ...
                      <td class="info">Accuracy at work</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                     ...
                     <tr>
                      ...
                      <td class="danger">Oral Skills Improvement</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                     ...
                     <tr>
                      ...
                      <td class="info">Written Skills Improvement</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                    ...
                    <tr>
                      ...
                      <td class="danger">Following Rules And Regulations</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                    ...
                    <tr>
                      ...
                      <td class="info">Following Given Instructions</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                    ...
                    <tr>
                      ...
                      <td class="danger">Planning And Organizing The Work</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                    ...
                    <tr>
                      ...
                      <td class="info">Relationship With Others</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
                    ...
                    <tr>
                      ...
                      <td class="danger">Applying leave / Permission</td>
                    </tr>
                    <tr><td></td><td>
                      <label class="radio-inline">
