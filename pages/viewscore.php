...
<div id="page-wrapper">
 ...
 <h2 align="center"><?php echo ''.$_SESSION['username'];?> Result</h2>   
...
$mainscore = 0;
$result1 = 0 ;
$query = "SELECT * FROM result WHERE fid = '" . $_SESSION['id'] . "' ";
...
?>      
 ...
 <!-- ======================================================================================================  -->
  ...
  <h2 align="center"> Student Enrichment Activities </h2>   
...
$output = '';
$eventsconducted = 0;
$query = "SELECT * FROM events WHERE   fid = '" . $_SESSION['id'] . "' ";
$result = mysqli_query($connect, $query);
$output = '
<br />
<table class="table table-bordered table-striped">
...
$output = '';
$feedbackscore =0;
$query = "SELECT * FROM hodfeedback WHERE fid = '" . $_SESSION['id'] . "' ";
$result = mysqli_query($connect, $query);
...
$studentfeedback = 0;
$count =1;
$query = "SELECT * FROM studentfeedback WHERE fid = '" . $_SESSION['id'] . "' ";
$result = mysqli_query($connect, $query);
...
while($row = mysqli_fetch_array($result))
{
 ...
 // $feedbackscore1 = $row['q1'] + $row['q2'] + $row['q3'] + $row['q4'] + $row['q5'] + $row['q6'] + $row['q7'] + $row['q8'] +$row['q9'] + $row['q10'] + $row['q11'] + $row['q12'] + $row['q13'] + $row['q14'] + $row['q15'] + $row['q16'] + $row['q17'] + $row['q18'] + $row['q19'] + $row['q20'] ;
...
<!-- ======================================================================================================  -->
 ...
 <br>
         <table  class="table table-bordered table-striped">
           <tr>
             <th align="center"><center><?php echo ''.$_SESSION['username'];?> Total Performance Score</center> </th>
           </tr>
            <tr>
             <td align="center"> 
              <?php 
